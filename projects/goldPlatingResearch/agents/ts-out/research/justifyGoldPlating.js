    ...
    async justifyNationalRegulationGoldPlating(researchItem) {
        ...
        for (const regulation of researchItem.nationalRegulation) {
            ...
            for (const article of regulation.articles) {
                ...
                if (article.research?.possibleGoldPlating) {
                    const justification = await this.analyzeJustification(article, researchItem.euDirective.fullText, article.research.englishTranslationOfIcelandicArticle, article.research.euLawExtract || "N/A", allSupportText);
