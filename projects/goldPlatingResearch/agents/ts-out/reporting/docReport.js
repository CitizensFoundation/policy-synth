...
export class GoogleDocsReportAgent extends PolicySynthAgent {
    ...
    generateReportContent(researchItem, rankedArticles) {
        let content = "";
    ...
    generateExecutiveSummary(rankedArticles) {
    ...
    generateDetailedFindings(rankedArticles) {
        let findings = "";
    ...
    generateConclusion(rankedArticles) {
...
//# sourceMappingURL=docReport.js.map