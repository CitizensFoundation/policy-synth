...
`;
    mainStreamingUserPrompt = (latestQuestion, context, countryLinksInfo, euSignpostsInfo) => `<CONTEXT_TO_ANSWER_USERS_QUESTION_FROM>
${context}
...
`;
    ...
    async ecasYeaConversation(chatLog) {
        ...
        */
        ...
        const userPrompt = this.mainStreamingUserPrompt(finalUserQuestionText, JSON.stringify(this.searchContext, null, 2), countryLinksInfo, euSignpostsInfo);
