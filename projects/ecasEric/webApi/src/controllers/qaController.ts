...
export class QAController extends BaseController {
  ...
  private listQAPairs = async (req: Request, res: Response) => {
    const { topicId, page, pageSize } = req.query;
    try {
      const result = await this.qaService.list(
  ...
  private getQAPair = async (req: Request, res: Response) => {
    const { id } = req.params;
    try {
  ...
  private createQAPair = async (req: Request, res: Response) => {
  ...
  private updateQAPair = async (req: Request, res: Response) => {
    const { id } = req.params;
  ...
  private deleteQAPair = async (req: Request, res: Response) => {
    const { id } = req.params;
    try {
  ...
  private importXLSX = async (req: Request, res: Response) => {
    if (!req.file) {
