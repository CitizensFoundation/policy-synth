export class JobDescriptionBucketAgent {
   ...
   */
  static bucketJobDescriptions(jobDescriptions: JobDescription[]): { [bucket: string]: JobDescription[] } {
    ...
    const buckets: { [key: string]: JobDescription[] } = {};
    ...
    const selected: { [key: string]: JobDescription[] } = {};
