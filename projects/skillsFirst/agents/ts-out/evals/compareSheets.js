...
`.trim();
        ...
        let result = (await this.callModel(PsAiModelType.TextReasoning, PsAiModelSize.Medium, messages));
        if (!result) {
            ...
            result = (await this.callModel(PsAiModelType.Text, PsAiModelSize.Large, messages));
        }
