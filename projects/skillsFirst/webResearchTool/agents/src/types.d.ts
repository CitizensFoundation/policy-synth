...
interface DataConsistencyChecks {
  cscRevisedConsistency?: string | boolean;
  ...
  requiredAlternativeExplanationConsistency?: string | boolean;
  ...
  needsCollegeDegreeConsistency?: string | boolean;
  ...
  educationRequirementsConsistency?: string | boolean;
  ...
  alternativeQualificationsConsistency?: string | boolean;
  ...
  alternativesIfTrueConsistency?: string | boolean;
  ...
  licenseIncludesDegreeRequirementConsistency?: string | boolean;
  // If professionalLicenseRequirement.includesDegreeRequirement is true,
  // then either degreeRequirementStatus.isDegreeMandatory/isDegreeAbsolutelyRequired or
  // degreeRequirementStatus.hasAlternativeQualifications/multipleQualificationPaths should be true,
  // and degreeRequirementStatus.alternativeQualifications should be filled in.

  barriersToNonDegreeApplicantsConsistency?: string | boolean;
