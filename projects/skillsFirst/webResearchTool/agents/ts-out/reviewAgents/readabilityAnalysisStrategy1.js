...
export class ReadabilityAnalysisAgent extends PolicySynthAgent {
    ...
    async processJobDescription(jobDescription) {
        await this.updateRangedProgress(0, `Performing readability analysis for ${jobDescription.name}`);
        // Ensure readabilityAnalysis exists
        jobDescription.readabilityAnalysis = jobDescription.readabilityAnalysis || {};
...
//# sourceMappingURL=readabilityAnalysisStrategy1.js.map