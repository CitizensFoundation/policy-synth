export class EvidenceExamplePrompts {
  static render(evidenceType: PSEvidenceWebPageTypes): string {
    switch (evidenceType) {
  ...
  private static renderPositiveEvidence(): string {
    return `
      Open data portals
  ...
  private static renderNegativeEvidence(): string {
    return `
  ...
  private static renderNeutralEvidence(): string {
    return `
  ...
  private static renderEconomicEvidence(): string {
    return `
  ...
  private static renderScientificEvidence(): string {
    return `
      Executive summary
  ...
  private static renderCulturalEvidence(): string {
    return `
  ...
  private static renderEnvironmentalEvidence(): string {
    return `
      Key points
  ...
  private static renderLegalEvidence(): string {
    return `
  ...
  private static renderTechnologicalEvidence(): string {
    return `
  ...
  private static renderGeopoliticalEvidence(): string {
    return `
      1
      Context
  ...
  private static renderCaseStudies(): string {
    return `
  ...
  private static renderStakeholderOpinions(): string {
    return `
      HOW GOVERNMENT
      CAN PROMOTE
      OPEN DATA AND HELP
  ...
  private static renderExpertOpinions(): string {
    return `
  ...
  private static renderPublicOpinions(): string {
    return `
      Details
  ...
  private static renderHistoricalContext(): string {
    return `
  ...
  private static renderEthicalConsiderations(): string {
    return `
  ...
  private static renderLongTermImpact(): string {
    return `
  ...
  private static renderShortTermImpact(): string {
    return `
  ...
  private static renderLocalPerspective(): string {
    return `
  ...
  private static renderGlobalPerspective(): string {
    return `
  ...
  private static renderCostAnalysis(): string {
    return `
  ...
  private static renderImplementationFeasibility(): string {
    return `
