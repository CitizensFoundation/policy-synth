...
let PsFamilyTree = class PsFamilyTree extends YpBaseElement {
    ...
    getParentSolution(parent) {
        ...
        return this.memory.subProblems[this.subProblemIndex].solutions.populations[populationIndex][solutionIndex];
    }
    renderFamilyTree(currentSolution, first = false, isMutatedFrom = false) {
      ...
      <div class="tree-structure layout vertical center-center">
            ...
            : html `
                ...
                ? html `
                        <div class="solution-box">
                          Seed URLs:
                          ${currentSolution.family.seedUrls.map(url => html `<a
                                href="${url}"
                                target="_blank"
                                class="url-link"
                                >${url}</a
        ...
        >
          ...
          >
            ${currentSolution.family?.parentA
            ? html `
                  ${this.renderFamilyTree(this.getParentSolution(currentSolution.family.parentA), false, !hasParentB)}
                `
            : ''}
            ${currentSolution.family?.parentB
            ? html `
                  ${this.renderFamilyTree(this.getParentSolution(currentSolution.family.parentB))}
                `
            : ''}
          </div>
        </div>
...
], PsFamilyTree.prototype, "memory", void 0);
__decorate([
    property({ type: Number })
], PsFamilyTree.prototype, "subProblemIndex", void 0);
__decorate([
    property({ type: Object })
], PsFamilyTree.prototype, "solution", void 0);
PsFamilyTree = __decorate([
    customElement('ps-family-tree')
], PsFamilyTree);
export { PsFamilyTree };
//# sourceMappingURL=ps-family-tree.js.map