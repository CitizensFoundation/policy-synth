...
let PsOperationsAgent = class PsOperationsAgent extends YpBaseElement {
    constructor() {
        super();
...
], PsOperationsAgent.prototype, "nodeId", void 0);
__decorate([
    property({ type: Object })
], PsOperationsAgent.prototype, "agentClass", void 0);
__decorate([
    property({ type: Number })
], PsOperationsAgent.prototype, "agentId", void 0);
PsOperationsAgent = __decorate([
    customElement('ps-operations-agent')
], PsOperationsAgent);
export { PsOperationsAgent };
//# sourceMappingURL=ps-operations-agent.js.map