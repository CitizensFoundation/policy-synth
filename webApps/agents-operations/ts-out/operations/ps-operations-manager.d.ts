...
export declare class PsOperationsManager extends PsBaseWithRunningAgentObserver {
    ...
    private showAddConnectorDialog;
    ...
    closeAddConnectorDialog(): void;
    handleConnectorClassSelection(e: Event): void;
    handleAddConnector(): Promise<void>;
    renderAddConnectorDialog(): import("lit").TemplateResult<1>;
    ...
    handleAgentClassSelection(e: Event): void;
    handleAddAgent(): Promise<void>;
    renderAddAgentDialog(): import("lit").TemplateResult<1>;
    tabChanged(): void;
    clearForNew(): void;
