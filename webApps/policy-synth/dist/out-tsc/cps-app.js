...
import { applyThemeWithContrast, themeFromSourceColorWithContrast, } from './src/@yrpri/common/YpMaterialThemeHelper.js';
...
let CpsApp = class CpsApp extends YpBaseElement {
    constructor() {
        ...
        this.stageModelMap = {
            ...
            webSearch: IEngineConstants.createSearchQueriesModel,
            ...
            parse: IEngineConstants.createSubProblemsModel,
            save: IEngineConstants.createSubProblemsModel,
    ...
    async boot() {
        ...
        const firstBootResponse = (await window.serverApi.getProject(this.currentProjectId, this.tempPassword, location.pathname.indexOf('refresh827cDb') > -1 ? '999' : undefined));
    ...
    _setupEventListeners() {
        ...
        this.addGlobalListener('yp-external-goal-trigger', this.externalGoalTrigger.bind(this));
