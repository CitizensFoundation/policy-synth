...
let YpPostActions = class YpPostActions extends YpBaseElement {
      ...
      >
        ...
        >
          <md-filled-tonal-link-icon-button
            ...
            icon="${ifDefined(this.endorseModeIcon(this.endorsementButtons, 'up'))}"
    ...
    get hideDebate() {
        return (!this.forceShowDebate && (!this.wide ||
            this.forceSmall ||
            this.headerMode ||
            (this.post &&
                this.post.Group &&
    ...
    _setEndorsement(value) {
        ...
        if (this.endorsementButtons == 'hearts') {
            if (value > 0) {
                ...
                YpFormattingHelpers.removeClass(this.$$('#actionDown'), 'hearts-down-selected');
                this.$$('#iconUpButton').innerHTML = 'favorite';
            }
            else if (value < 0) {
                this.$$('#actionDown').className += ' ' + 'hearts-down-selected';
                YpFormattingHelpers.removeClass(this.$$('#actionUp'), 'hearts-up-selected');
                this.$$('#iconUpButton').innerHTML = 'favoriate_border';
            }
            else {
                YpFormattingHelpers.removeClass(this.$$('#actionUp'), 'hearts-up-selected');
                YpFormattingHelpers.removeClass(this.$$('#actionDown'), 'hearts-down-selected');
