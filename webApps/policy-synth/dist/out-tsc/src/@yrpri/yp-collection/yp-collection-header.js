...
let YpCollectionHeader = class YpCollectionHeader extends YpBaseElement {
    ...
    disconnectedCallback() {
        ...
        YpMediaHelpers.detachMediaListeners(this); //TODO: Remove unknown cast
    }
    firstUpdated(changedProperties) {
        super.firstUpdated(changedProperties);
        YpMediaHelpers.attachMediaListeners(this); //TODO: Remove unknown cast
    }
    ...
    _pauseMediaPlayback() {
        YpMediaHelpers.pauseMediaPlayback(this); //TODO: Remove unknown cast
    }
