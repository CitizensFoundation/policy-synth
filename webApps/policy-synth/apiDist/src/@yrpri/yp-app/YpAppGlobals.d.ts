...
export declare class YpAppGlobals extends YpCodeBase {
    ...
    constructor(serverApi: YpServerApi, disableParentConstruction?: boolean);
    ...
    activity(type: string, object: object | string, context?: string | object | number | undefined, target?: string | object | undefined): void;
    setSeenWelcome(): void;
