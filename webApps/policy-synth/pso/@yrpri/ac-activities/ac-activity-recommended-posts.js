...
let AcActivityRecommendedPosts = class AcActivityRecommendedPosts extends YpBaseElement {
    static get styles() {
        return [
            super.styles,
            ShadowStyles,
...
], AcActivityRecommendedPosts.prototype, "recommendedPosts", void 0);
AcActivityRecommendedPosts = __decorate([
    customElement('ac-activity-recommended-posts')
], AcActivityRecommendedPosts);
export { AcActivityRecommendedPosts };
//# sourceMappingURL=ac-activity-recommended-posts.js.map