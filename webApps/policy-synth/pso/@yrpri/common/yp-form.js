...
*/
let YpForm = class YpForm extends YpBaseElement {
    constructor() {
        super(...arguments);
        /**
    ...
    _init() {
        this._form.addEventListener('submit', this.submit.bind(this), false);
        this._form.addEventListener('reset', this.reset.bind(this), false);
    ...
    reset(event) {
        ...
        this.dispatchEvent(new CustomEvent('yp-form-reset', { bubbles: true, composed: true }));
    }
    /**
    ...
    async _makeAjaxRequest(json) {
        ...
        const formResults = (await window.serverApi.submitForm(url, method, headers, bodyParams));
        if (formResults != null) {
     ...
     * @private
     */
    _findElements(parent, ignoreName, skipSlots, submittable = undefined) {
    ...
    _createHiddenElement(name, value) {
...
], YpForm.prototype, "headers", void 0);
YpForm = __decorate([
    customElement('yp-form')
], YpForm);
export { YpForm };
//# sourceMappingURL=yp-form.js.map