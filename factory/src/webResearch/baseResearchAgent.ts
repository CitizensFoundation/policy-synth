...
export abstract class PsAgentFactoryBaseWebResearchAgent extends PolicySynthScAgentBase {
  ...
  async doWebResearch() {
    ...
    try {
      ...
      const searchQueriesGenerator = new SearchQueriesGenerator(
        this.memory as PsAgentFactoryMemoryData,
