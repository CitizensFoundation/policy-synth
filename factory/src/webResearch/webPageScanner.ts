...
export class WebPageScanner extends GetWebPagesProcessor {
  declare memory: PsAgentFactoryMemoryData;
  scanType?: PsAgentFactoryWebResearchTypes;
  instructions: string;

  collectedWebPages: any[] = [];

  constructor(memory: PsAgentFactoryMemoryData, instructions: string) {
...
`
  ...
  async scan(listOfUrls: string[], scanType: PsAgentFactoryWebResearchTypes) {
