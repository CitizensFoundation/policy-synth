...
`;
  ...
  renderTaskContext(
    fileName: string,
    currentActions: PsAgentFactoryCodingActionPlanItem[],
    completedActions: PsAgentFactoryCodingActionPlanItem[],
    futureActions: PsAgentFactoryCodingActionPlanItem[],
  ...
  async implementCodingActionPlan(
    actionPlan: PsAgentFactoryCodingActionPlanItem[],
    currentErrors: string | undefined
  ) {
    this.setCurrentErrors(currentErrors);
    let currentActions: PsAgentFactoryCodingActionPlanItem[] = [];
    let completedActions: PsAgentFactoryCodingActionPlanItem[] = actionPlan.filter(
      (action) => action.status === "completed"
    );
    let futureActions: PsAgentFactoryCodingActionPlanItem[] = [];
