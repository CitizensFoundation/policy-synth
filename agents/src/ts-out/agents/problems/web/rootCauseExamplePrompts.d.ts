export declare class RootCauseExamplePrompts {
    ...
    static renderScientificRootCause(): string;
    static renderCulturalRootCause(): string;
    static renderSocialRootCause(): string;
    static renderEnvironmentalRootCause(): string;
    static renderLegalRootCause(): string;
    static renderTechnologicalRootCause(): string;
    static renderGeopoliticalRootCause(): string;
