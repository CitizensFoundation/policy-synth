...
export declare class AgentConnectorManager {
    ...
    createYourPrioritiesGroupAndUpdateAgent(agent: PsAgent, agentClass: PsAgentClass, agentConnector: PsAgentConnector, type: "input" | "output"): Promise<YpGroupData>;
    getHeaders(): {
        [key: string]: string;
    };
    createGroup(currentGroupId: number, forAgentId: number, inputOutput: "input" | "output", communityId: number, userId: number, name: string, description: string, structuredQuestions: any[]): Promise<unknown>;
