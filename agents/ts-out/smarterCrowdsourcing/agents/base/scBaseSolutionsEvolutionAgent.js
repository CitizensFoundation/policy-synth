...
export class SolutionsEvolutionSmarterCrowdsourcingAgent extends BaseSmarterCrowdsourcingAgent {
    ...
    static SOLUTIONS_EVOLUTION_AGENT_CLASS_VERSION = 1;
    static getAgentClass() {
        return {
            ...
            available: true,
            configuration: {
                description: "An agent for evolving solutions in the Smarter Crowdsourcing process",
...
//# sourceMappingURL=scBaseSolutionsEvolutionAgent.js.map