...
const setupProjectThree = (memory) => {
    if (!memory.customInstructions) {
        memory.customInstructions = {};
    }
...
const setupProjectSeven = (memory) => {
    if (!memory.customInstructions) {
        memory.customInstructions = {};
    }
    /* BATCH A
...
const setupProjectEight = (memory) => {
    if (!memory.customInstructions) {
        memory.customInstructions = {};
    }
