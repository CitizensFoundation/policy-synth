...
export class SolutionsSmarterCrowdsourcingAgent extends BaseSmarterCrowdsourcingAgent {
    static SOLUTIONS_AGENT_CLASS_BASE_ID = "b2a5d8f1-5e8a-4b1d-8c2c-7d45e3b1f123";
    static SOLUTIONS_AGENT_CLASS_VERSION = 1;
    static getAgentClass() {
        return {
            class_base_id: this.SOLUTIONS_AGENT_CLASS_BASE_ID,
            user_id: 0,
            name: "Smarter Crowdsourcing Solutions Agent",
            version: this.SOLUTIONS_AGENT_CLASS_VERSION,
            available: true,
            configuration: {
...
//# sourceMappingURL=scBaseSolutionsAgent.js.map