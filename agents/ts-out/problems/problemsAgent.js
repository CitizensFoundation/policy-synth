...
export class ProblemsAgent extends AgentProblemsProcessor {
    ...
    async process() {
        ...
        const createSubProblemsProcessor = new CreateSubProblemsProcessor(this.job, this.memory);
        ...
        const rankRootCausesSearchResults = new RankRootCausesSearchResultsProcessor(this.job, this.memory);
    ...
    async setup() {
        ...
        new Worker("agent-class-smarter-crowdsourcing-problems", async (job) => {
