...
async function addUserToAllAgentClasses(userEmail) {
    try {
        ...
        for (const agentClass of agentClasses) {
            ...
            if (!hasUserAccess) {
                ...
                console.log(`User ${user.email} added as user to agent class ${agentClass.id}`);
            }
            else {
                console.log(`User ${user.email} already has user access to agent class ${agentClass.id}`);
            }
            ...
            if (!hasAdminAccess) {
                ...
                console.log(`User ${user.email} added as admin to agent class ${agentClass.id}`);
            }
            else {
                console.log(`User ${user.email} already has admin access to agent class ${agentClass.id}`);
            }
        }
    }
    catch (error) {
...
//# sourceMappingURL=addUserToAllAgentClasses.js.map