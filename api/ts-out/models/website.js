...
const embeddings_1 = require("../openai/embeddings");
...
class Website extends sequelize_2.Model {
    ...
    static async getSimilar(searchTerm, skip = 0, limit = 9999) {
        const embedding = await (0, embeddings_1.createEmbedding)(searchTerm);
...
Website.addHook("beforeCreate", async (website) => {
    ...
    const embedding = await (0, embeddings_1.createEmbedding)(input);
