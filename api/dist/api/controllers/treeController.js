...
export class TreeController extends BaseController {
    constructor(wsClients) {
        ...
        this.updateNodeChildren = async (req, res) => {
            const treeId = req.params.id;
        ...
        this.runValidationChain = async (req, res) => {
        ...
        this.getRefinedCauses = async (req, res) => {
        ...
        this.addDirectCauses = async (req, res) => {
            const treeId = req.params.id;
        ...
        this.reviewTreeConfiguration = async (req, res) => {
        ...
        this.createDirectCauses = async (req, res) => {
            const treeId = req.params.id;
            const parentNodeId = req.body.parentNodeId;
            try {
        ...
        this.getParentNodes = (nodes, childId) => {
        ...
        this.findNearestUde = (nodes, nodeId) => {
